...
Revision ID: 001
Revises:
Create Date: 2023-04-10 11:00:22.737640
...
def upgrade() -> None:
    ...
    sa.Column('subsidiary', sa.Enum('CHILD', 'PARENT', name='counteragentsubsidiary'), nullable=True),
    ...
    op.create_index(op.f('ix_counteragent_inn'), 'counteragent', ['inn'], unique=False)
